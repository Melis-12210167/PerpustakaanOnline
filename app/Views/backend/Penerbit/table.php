...
<div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-900">Penerbit</h1>
...
<script>
    $(document).ready(function(){
        ...
        $('table#table-penerbit').on('click', '.btn-edit', function(){
            let id = $(this).data('id');
        ...
        $('table#table-penerbit').on('click', '.btn-hapus', function(){
            ...
            if(konfirmasi === true){
                ...
                $.post(`${baseurl}/penerbit`, {id:_id, _method:'delete'}).done(function(e){
                    $('table#table-penerbit').DataTable().ajax.reload();
                });
            }
        }); 
