...
class PustakawanController extends BaseController
{
    ...
    public function lupaPassword(){
        ...
        $email->setFrom('melismel.mm@gmail.com', 'Sistem Perpustakaan Online');
    ...
    public function all(){
        ...
        $pm->select('id, nama_lengkap, gender, tgl_lhr, level, email, nohp, alamat, kota, token_reset');

        return (new Datatable( $pm ))
            ->setFieldFilter(['nama_lengkap', 'gender', 'tgl_lhr', 'level', 'email', 'nohp', 'alamat', 'kota', 'token_reset'])
            ->draw();
    }
