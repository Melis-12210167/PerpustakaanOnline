...
class TransaksiController extends BaseController
{
    ...
    public function all(){
        ...
        return (new Datatable( TransaksiModel::view() ))
                ->setFieldFilter(['tgl_pinjam', 'tgl_harus_kembali', 'tgl_kembali', 'anggota', 'stokkoleksi', 'pustakawan', 'kembalipustakawan_id', 'denda', 'status_trx', 'catatan'])
                ->draw();
    }
    ...
    public function store(){
        ...
        $id = $pm->insert([
            ...
            'kembalipustakawan_id'  => $this->request->getVar('kembalipustakawan_id'),
